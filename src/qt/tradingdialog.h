...
private slots:
    ...
    QString BuyXIOS(QString OrderType, double Quantity, double Rate);
    QString SellXIOS(QString OrderType, double Quantity, double Rate);
